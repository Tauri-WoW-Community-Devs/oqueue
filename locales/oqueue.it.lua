...
OQ.BAD_REALID = 'real-id o tauri-tag invalido.\n'
...
OQ.DLG_17 = 'Perfavore inserisci il tuo tauri-tag per ban:'
...
OQ.NOBTAG_01 = ' informazioni tauri-tag non ricevuti in tempo.'
...
OQ.TT_FINDMESH = 'richiedi il tauri-tags dal segnapunti\nper connetterti nella rete'
OQ.TT_SUBMIT2MESH = 'inserisci il tuo tauri-tag sul segnapunti\nper aiutare a far crescere la rete'
...
OQ.UP = 'sopra'
OQ.DOWN = 'sotto'
OQ.BAD_KARMA_BTAG = 'OQ: il tauri-tag del membro del gruppo selezionato non è valido'
...
OQ.DEATHMATCH_BEGINS =
    'Lo scontro di sangue PVP è iniziato!  Arrivate alla colonna vertebrale in Pandaria e difendete i vostri fornitori PVP!'
...
--
L[' Please set your tauri-tag before using oQueue.'] = 'Perfavore imposta il tuo tauri-tag prima di usare oQueue'
L[' Your tauri-tag can only be set via your WoW account page.'] =
    "Il tuo tauri-tag può essere impostato solo sulla pagina dell'account di WoW"
