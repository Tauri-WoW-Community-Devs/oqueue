...
OQ.BAD_REALID = 'Ungueltige real-id/tauri-tag.n'
...
OQ.MSG_NOTLFG =
    'Bitte verwende OQueue nicht als LFG-Werbung. nEinige Spieler k�nnten dich sonst aus ihren Vorgefertigten Gruppen bannen'
...
OQ.DLG_17 = 'Bitte gib den zu bannenden tauri-tag ein:'
...
OQ.NOBTAG_01 = ' tauri-tag Information nicht rechtzeitig erhalten.'
...
OQ.TT_FINDMESH = 'request tauri-tags from the scorekeepernto get connected to the mesh' --dunno
OQ.TT_SUBMIT2MESH = 'submit your tauri-tag to the scorekeepernto help grow the mesh' --dunno
...
OQ.BG_NAMES = {
    ['Zuf�lliges Schlachtfeld'] = {type_id = OQ.RND},
...
OQ.BG_STAT_COLUMN = {
    ['Bases Assaulted'] = 'Base Assaulted', --dunno which one has to be translated
