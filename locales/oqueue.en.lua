...
OQ.BAD_REALID = 'Invalid real-id or Tauri-tag.\n'
...
OQ.BUT_SUBMIT2MESH = 'Submit Tauri-tag'
OQ.BUT_PULL_BTAG = 'Remove Tauri-tag'
OQ.BUT_BAN_BTAG = 'Ban Tauri-tag'
...
OQ.SETUP_REMOVEBTAG = 'Remove Tauri-tag from scorekeeper'
...
OQ.SETUP_AUTOACCEPT_MESH_REQ = 'Auto accept Tauri-tag mesh requests'
OQ.SETUP_OK2SUBMIT_BTAG = 'Submit Tauri-tag every 4 days'
...
OQ.DLG_17 = 'Please enter the Tauri-tag to ban:'
...
OQ.NOBTAG_01 = ' Tauri-tag information not received in time.'
...
OQ.TT_FINDMESH = 'request Tauri-tags from the scorekeeper\nto get connected to the mesh'
OQ.TT_SUBMIT2MESH = 'submit your Tauri-tag to the scorekeeper\nto help grow the mesh'
...
OQ.UP = 'up'
OQ.DOWN = 'down'
OQ.BAD_KARMA_BTAG = "OQ: selected group member's Tauri-tag is invalid"
...
--
L[' Please set your Tauri-tag before using oQueue.'] = nil
L[' Your Tauri-tag can only be set via your WoW account page.'] = nil
