...
OQ.BAD_REALID = 'Real-id ou Tauri-tag invalida.\n'
...
OQ.DLG_17 = 'Por favor entre a Tauri-tag para banir:'
...
OQ.NOBTAG_01 = ' informação de Tauri-tag não recebida a tempo.'
...
OQ.TT_FINDMESH = 'requirir Tauri-tags do mantenedor do placar\npara se conectar com a rede'
OQ.TT_SUBMIT2MESH = 'enviar sua Tauri-tag ao mantenedor do placar\npara ajudar a crescer a rede'
