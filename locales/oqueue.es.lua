...
OQ.UP = 'mas'
OQ.DOWN = 'menos'
OQ.BAD_KARMA_BTAG = 'OQ: el tauri-tag del miembro de grupo seleccionado no es valido'
...
OQ.DEFEAT_EMOTES = {}
OQ.DEFEAT_EMOTES[
        'El Sha del odio ha abandonado mi cuerpo... y el monasterio. Os lo agradezco, forasteros. El Shadopan está en deuda con vosotros. Ahora queda mucho trabajo por hacer...'
    ] = 56884 -- Taran Zhu
