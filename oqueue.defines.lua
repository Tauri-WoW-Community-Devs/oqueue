...
OQ.CLASS_SPEC = {
    ...
    [102] = {id = 4, type = OQ.CASTER, n = 'DR.Balance', spy = 'Knockback'},
    ...
    [270] = {id = 16, type = OQ.HEALER, n = 'MK.Mistweaver', spy = 'Healer'},
    [65] = {id = 17, type = OQ.HEALER, n = 'PA.Holy', spy = 'Healer'},
    ...
    [262] = {id = 26, type = OQ.CASTER, n = 'SH.Elemental', spy = 'Knockback'},
